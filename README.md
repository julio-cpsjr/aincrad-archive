...
Dominar os conceitos de **Programação Orientada a Objetos (POO)** e a modelagem de **regras de negócio**, utilizando Java puro e estruturas de dados da linguagem.
...
- Histórico simples de empréstimos
